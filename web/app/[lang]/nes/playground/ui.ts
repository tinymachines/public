...
const EN = {
  ...
  hero: {
    ...
    carts: {
      ...
      own: "Read from your disk (or your shelf) into this browser, and nowhere else. The console loads the boards it has and refuses any other by name.",
    },
    pad: "The controller",
  },
  wire: {
...
const JA: Dict = {
  ...
  hero: {
    ...
    carts: {
      ...
      own: "あなたのディスク (または棚) からこのブラウザに読み込むだけで、どこにも送られません。コンソールは自分が持っている基板を読み込み、それ以外は名前を挙げて断ります。",
    },
    pad: "コントローラ",
  },
  wire: {
