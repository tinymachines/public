...
const DOCS = [
  ...
  { repo: "nes-bench", file: "pad-ble-build.md", slug: "pad-ble", code: null, kind: "procedure", title: "An original pad as a USB or Bluetooth keyboard", group: "bench-build", order: 39.5, artefacts: ["padble"], description: "The standalone adapter, drawn to build from and not yet built: the part read off its own silkscreen, the headers measured, the drawings, and why the build moved twice, to a P4 module when the C6 would not take a flash, and then from Bluetooth to USB when the module's radio link crashed." },
