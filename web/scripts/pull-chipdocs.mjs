...
for (const d of DOCS) {
  ...
  if (!/Generated by `tools\//.test(raw.slice(0, 600))) {
    throw new Error(
      `${d.file} does not say it is generated. Only their generated documents ` +
        "are pulled: an authored file changing hands silently is how two trees " +
        "end up with two versions of one document.",
    );
  }
