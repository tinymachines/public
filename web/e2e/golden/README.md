...
| `tracer-golden-{phone,desk}.jpg` | /6502/tracer | 2026-08-27, 1.0.134 | the reference (owner's call): both set as paragraphs by pretext, the prose in 23 headed chunks (data/articles.json), each folded behind a faded peek and "Read on ›", the article link in the prose gutter; 11,468 CSS px tall at 390, 8,268 at 1280. (At 1.0.133, one fold per section, it was 6,846 and 4,081.) |
